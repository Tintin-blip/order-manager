...
export const addOrder = async (req = request , res = response) => {
    try {
        ...
        const query = await connection.query(sql1 , values1);
        
        //codigo para buscar el precio del producto
        const product = await connection.query("SELECT price FROM products WHERE id = ?" ,[idProduct]);
        ...
        const insertToOrder = await connection.query(sql2 , values2);
...
export const getOrder = async (req = request , res = response) => {
    try {
        ...
        const orders = await connection.query(sql , values);
...
export const patchOrder = async (req = request , res = response) => {
    try {
        ...
        const searchOrder = await connection.query(sql1 , values1);
        ...
        const updateOrder = await connection.query(sql2 , values2);
...
export const deleteOrder = async (req = request , res = response) => {
    try {
        ...
        const deleteOrder = await connection.query(sql , values);
